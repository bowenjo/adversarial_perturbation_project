...
def load_MNIST(
  ...
  ## Training set
  train_img_filename = data_dir+os.sep+"train-images-idx3-ubyte.gz"
  train_lbl_filename = data_dir+os.sep+"train-labels-idx1-ubyte.gz"
  train_val = MNIST(
    train_img_filename,
    train_lbl_filename,
    num_val=num_val,
  ...
  ## Test set
  test_img_filename = data_dir+os.sep+"t10k-images-idx3-ubyte.gz"
  test_lbl_filename = data_dir+os.sep+"t10k-labels-idx1-ubyte.gz"
  test = MNIST(
    test_img_filename,
    test_lbl_filename,
    num_val=0,
